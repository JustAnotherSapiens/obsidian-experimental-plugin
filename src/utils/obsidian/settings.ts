...
// export function getAppSetting(setting: SettingKey): any {
//   return this.app.plugins.plugins[PLUGIN_ID].settings[setting];
// }


export function getSetting(app: App, key: SettingKey): any {
  return (app as any).plugins.plugins[PLUGIN_ID].settings[key];
}
